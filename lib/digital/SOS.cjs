...
class SOS {
  static fromZPK(zZeros, zPoles, gain=1){
    ...
    while(pi<pp.length){
      ...
      const sumZ={re:z1.re+z2.re, im:z1.im+z2.im}, prodZ=core_Complex.Cx.mul(z1,z2);
      const sumP={re:p1.re+p2.re, im:p1.im+p2.im}, prodP=core_Complex.Cx.mul(p1,p2);
