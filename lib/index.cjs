...
var iir = require('./iir-Btez-fr5.js');
...
const IIR = {
    ...
    cheby2: (kind, cutoffHz, fs, order, rs=40) => {
        const result = iir.IIRDesigner.cheby2(kind, cutoffHz, fs, order, rs);
        return { b: result.b, a: result.a };
    },
    linkwitzRiley: (kind, cutoffHz, fs, orderEven=4) => {
        const result = iir.IIRDesigner.linkwitzRiley(kind, cutoffHz, fs, orderEven);
        return { b: result.b, a: result.a };
    },
    apply: (b, a, x) => {
...
var index = {
    ...
    FIRDesigner: fir.FIRDesigner, IIRDesigner: iir.IIRDesigner,
    ZDomain: zdomain.ZDomain, Filter: filter.Filter,
    // Individual filter classes
    ButterworthFilter: iir.ButterworthFilter, ChebyshevFilter: iir.ChebyshevFilter, ChebyshevType2Filter: iir.ChebyshevType2Filter, LinkwitzRileyFilter: iir.LinkwitzRileyFilter, EllipticFilter: iir.EllipticFilter, BesselFilter: iir.BesselFilter, BaseIIRFilter: iir.BaseIIRFilter,
...
exports.BaseIIRFilter = iir.BaseIIRFilter;
exports.BesselFilter = iir.BesselFilter;
exports.ButterworthFilter = iir.ButterworthFilter;
exports.ChebyshevFilter = iir.ChebyshevFilter;
exports.ChebyshevType2Filter = iir.ChebyshevType2Filter;
exports.EllipticFilter = iir.EllipticFilter;
exports.IIRDesigner = iir.IIRDesigner;
exports.LinkwitzRileyFilter = iir.LinkwitzRileyFilter;
